...
def runner():
  ...
  elecEng = ["LAWS1000","PHIL1037","STAT1170","MHIS1001","ENGG1000","ENGG1050","ENGG2000","ENGG2050","ENGG3000","ENGG3050","ENGG4001","MATH1010","MATH1020","COMP1000","PHYS1510","PHYS1520","MATH2055","ELEC2005","ELEC2040","ELEC2042","ELEC2070","ELCT3005","ELCT3006","ELEC3024","ELEC3042","ELEC3076","TELE3350","ELC4001","ELCT4004","ELEC4250","ELEC4092","ELEC4093"]
  mechanicalEng = ["LAWS1000","PHIL1037","STAT1170","MHIS1001","ENGG1000","ENGG1050","ENGG2000","ENGG2050","ENGG3000","ENGG3050","ENGG4001","MATH1010","MATH1020","COMP1000","MECH1001","PHYS1510","MATH2055","MECH2001","MECH2002","MECH2003","MECH2004","MECH2005","MECH3001","MECH3002","MECH3003","MECH3004","MECH3005","MECH4001","MECH4002","MECH4092","MECH4093","MECH4005"]
  ...
  #testResults = binPacking(preReqMatrix,coReqMatrix,data,civilEng)
  #print(len(civilEng))
  #print(len(elecEng))
  #print(len(mechanicalEng))
  #print(len(mechatronicEng))
  #print(len(softwareEng))
